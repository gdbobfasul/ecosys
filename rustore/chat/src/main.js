...
enforceLicense('chat', 'rustore'); // лог на инсталация СЛЕД езика (rustore билд)
// Version: 1.0020
...
enforceLock();
mountEcosystem('chat'); // „Още от Pupikes" showcase
playIntro(); // кратко „Pupikes" интро при старт
startPromoAds('chat'); // реклами: старт (след интрото) + среда + край (PUPIKES_END_AD)
...
mountLegalGate('chat'); // ЕКРАН 3: задължителни политики/предупреждения + отметка (стандарт)
