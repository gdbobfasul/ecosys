...
// RUStore акцент: синьо (различава се от huawei изданието).
const ACCENT = '#1f6feb';
...
const splash = `<svg xmlns="http://www.w3.org/2000/svg" width="2048" height="2048" viewBox="0 0 2048 2048">
  ...
  <text x="1024" y="1480" font-family="system-ui,Segoe UI,Roboto,sans-serif" font-size="104" font-weight="700" fill="#e6edf3" text-anchor="middle">${LABEL}</text>
</svg>`;

writeFileSync('store/icon.svg', icon);
writeFileSync('store/splash.svg', splash);
console.log('Generated store/icon.svg and store/splash.svg (RUStore accent ' + ACCENT + ')');
