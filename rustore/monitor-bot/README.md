...
> Близнак: `huawei/monitor-bot` е идентично, независимо приложение. Различават се
...
```
Store SDK заглушката е `src/store/rustore-sdk.js` (премиум наемът е no-op).
...
src/
  ...
  store/rustore-sdk.js IAP заглушка (no-op)
