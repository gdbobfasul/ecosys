...
// Тема за RUStore (топъл рубинен акцент). Различава се от huawei копието.
const THEME = {
  bgTop: '#2a0f0c',
  bgBottom: '#06060a',
  primary: '#c0392b',
...
function icon(size) {
  ...
  <circle cx="120" cy="110" r="3" fill="#f6d6a8" opacity="0.7"/>
  <circle cx="400" cy="150" r="2.5" fill="${THEME.accent}" opacity="0.7"/>
  <circle cx="150" cy="400" r="2" fill="#f6d6a8" opacity="0.6"/>
...
function splash() {
  ...
  <text x="540" y="1180" font-family="Georgia, serif" font-size="92"
        font-weight="bold" fill="#f6d6a8" text-anchor="middle">ДУЕЛ НА РИНГА</text>
