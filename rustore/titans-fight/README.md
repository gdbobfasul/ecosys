...
## 5. RUStore SDK
Билинг/ревю SDK **не е интегриран** — играта е безплатна и офлайн.
TODO стъбове: `src/store/rustore-sdk.js`. Store бележки: `store/`.
...
├─ README.md
├─ store/                 # RUStore listing/testing/checklist
└─ src/
   ...
   └─ store/rustore-sdk.js  # billing/review СТЪБ (no-op)
```
