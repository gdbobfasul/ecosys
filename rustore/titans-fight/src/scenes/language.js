...
export class LanguageScene extends Phaser.Scene {
  ...
  create() {
    ...
    bg.fillGradientStyle(0x1a0a22, 0x1a0a22, 0x0a0612, 0x0a0612, 1);
    bg.fillRect(0, 0, W, H);
    ...
    LANGUAGES.forEach((lang, i) => {
      ...
      const color = isCur ? THEME.accent : 0x2a1a32;
      ...
      const label = this.add.text(x, y, lang.native, {
        ...
        color: isCur ? '#0a0612' : '#e6e6d8', fontStyle: 'bold'
      }).setOrigin(0.5);
    ...
    this.add.text(W / 2, H * 0.97, 'v' + APP_VERSION, {
      fontFamily: 'system-ui, sans-serif', fontSize: '12px', color: '#9a8aa8'
    }).setOrigin(0.5);
  }
