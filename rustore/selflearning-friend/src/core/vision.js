...
// --- Заявка за зрение от ГЛАСОВА команда в чата (виж responder.js) ----------
// Когато кажеш „виж“/„виж през предната“/„запази“, чатът отваря екрана „Зрение“ и му ОСТАВЯ
// тази заявка: коя камера да пусне, и дали веднага да хване кадър и да анализира. Екранът я чете
// ВЕДНЪЖ при отваряне (takeVisionIntent), за да не се задейства повторно при ръчно влизане.
let _visionIntent = null;
export function setVisionIntent(intent) { _visionIntent = intent || null; }
export function takeVisionIntent() { const i = _visionIntent; _visionIntent = null; return i; }
