...
function defaultState() {
  return {
    ...
    settings: {
      ...
      learnRole: 'learner',
      askOnReopen: false,  // АВТО-ЗАКЛЮЧВАНЕ при бездействие — по подразбиране ИЗКЛЮЧЕНО
                           // (не се самозаключва). Включва се от Настройки → Заключване,
                           // където се избира и таймаутът (5/10/30/60 мин).
      inactivityMin: 10,   // минути неактивност преди авто-заключване (когато е включено)
