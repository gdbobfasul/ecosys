...
// Силен сигнал по заявка (родителският екран го повтаря, докато родителят не го спре).
export function playAlarm() { try { alarmMelody(); } catch (_) {} }

// --- АЛАРМЕНА МЕЛОДИЯ за КРИТИЧНИ известия (непознат/пожар/плач) ---
