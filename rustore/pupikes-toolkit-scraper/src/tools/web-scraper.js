...
register({
  ...
  scr_backend_ph: { bg:'напр. https://pupikes.app/api/scraper', ru:'напр. https://pupikes.app/api/scraper', uk:'напр. https://pupikes.app/api/scraper', en:'e.g. https://pupikes.app/api/scraper', de:'z. B. https://pupikes.app/api/scraper', fr:'ex. https://pupikes.app/api/scraper', es:'p. ej. https://pupikes.app/api/scraper', 'es-MX':'p. ej. https://pupikes.app/api/scraper', it:'es. https://pupikes.app/api/scraper', pt:'ex. https://pupikes.app/api/scraper', ar:'مثال https://pupikes.app/api/scraper', hi:'उदा. https://pupikes.app/api/scraper', ja:'例 https://pupikes.app/api/scraper', ky:'мис. https://pupikes.app/api/scraper', 'zh-Hant':'例如 https://pupikes.app/api/scraper' },
