// main.js — магазинна обвивка на играта „Подземни" (Core Descent, GL1) за rustore.
// Играта е самостоятелен canvas-2D енджин (inline в index.html). Тук закачаме САМО
// СПОДЕЛЕНИТЕ ядрени модули (както fps-hunter): задължителен 15-езичен избор при старт,
