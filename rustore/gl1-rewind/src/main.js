// main.js — магазинна обвивка на играта „Обратното време" (GL1-Rewind) за rustore.
// Играта е самостоятелен canvas-2D енджин (inline в index.html). Тук закачаме САМО
// СПОДЕЛЕНИТЕ ядрени модули (както fps-hunter/gl1-gravity): задължителен 15-езичен избор при
// старт, анти-sideload лиценз, монетизация/пробно заключване, лого-интро, реклами, „Помощ",
// правен footer линк и правния екран (съгласие). Мостовете работят върху DOM/localStorage —
// не зависят от вътрешния енджин на играта.
