# Рутина-робот (Daily Routine Bot) — RUStore издание
...
на машина с Android Studio. RUStore IAP е STUB в `src/store/rustore-sdk.js` — за реални покупки
се интегрира RuStore Billing SDK на native слоя.
...
src/ui/                         styles, dom
src/store/sdk.js → rustore-sdk.js   IAP STUB
