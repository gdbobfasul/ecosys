...
## Икона
- Формат за store: PNG 512×512 (без алфа за някои изисквания — проверявай в Console).
...
- Акцент (RUStore): топло злато `#e0b34a`, фон `#0a0d08`.

## Splash
- Портрет 1080×1920 (`store/splash.svg`).
- Capacitor splash: ползвай `@capacitor/splash-screen` или статичен фон `#0a0d08`.
