 ...
 */
class PupikesNotificationListener : NotificationListenerService() {
    ...
    override fun onNotificationPosted(sbn: StatusBarNotification) {
        ...
        val canReply = PupikesNotificationListener.findReplyAction(n) != null
