// main.js — магазинна обвивка на ИИ-програмата „Справедлива подялба" (AIP1) за rustore.
// Програмата е самостоятелна (inline в index.html, с вграден ИИ-клиент PupikesAI). Тук закачаме
// САМО СПОДЕЛЕНИТЕ ядрени модули (както игрите): задължителен 15-езичен избор при старт,
