...
- Старт: 2026-06-09T09:38:22.535Z  ·  Времетраене: 30926 ms
...
|---|---|---|---|---|---|
| 🔴 | journey | chat |  | http://localhost:3000/chat/public/payment.html | label А праща съобщение на Б: изпращане на съобщение HTTP 500 Server error |
...
- 🔴 **РЕАЛНО ЧАТЕНЕ: А добавя Б за контакт → праща съобщение → Б го получава**
    - 🔴 изпращане на съобщение HTTP 500 Server error label А праща съобщение на Б
