<!-- Version: 1.0093 -->
# PUPIKES1 v1.1 FINAL - Отговор на Въпросите
...
#### Купуване (BNB → PUPIKES1):
```
User → Router: Изпраща BNB
Router → User: Изпраща PUPIKES1 tokens
...
#### Продажба (PUPIKES1 → BNB):
```
User → Router: Изпраща PUPIKES1 tokens
...
```
User → Router: Изпраща PUPIKES1 + BNB
...
```
Router → User: Връща PUPIKES1 tokens
...
### Пример 1: User купува 500 PUPIKES1
```
Step 1: User click "Buy 500 PUPIKES1" в PancakeSwap
Step 2: User изпраща ~0.5 BNB към Router
Step 3: Router swap-ва в pool
Step 4: Router изпраща 500 PUPIKES1 към User wallet
...
### Пример 2: User продава 800 PUPIKES1
```
Step 1: User click "Sell 800 PUPIKES1" в PancakeSwap
Step 2: User approve tokens към Router
Step 3: User изпраща 800 PUPIKES1 към Router
...
### Пример 3: User опитва да продаде 1,500 PUPIKES1
```
Step 1: User click "Sell 1,500 PUPIKES1"
...
├─ T0: Sell 1,000 PUPIKES1 ✅
└─ T0+2h: Sell 500 PUPIKES1 ✅
```
...
```
exemptAddress1 → Router (50,000 PUPIKES1 + 5 BNB)
...
**Версия:** 1.1 FINAL  
**Файл:** pupikes-meme-1-v1.1-FINAL.sol  
