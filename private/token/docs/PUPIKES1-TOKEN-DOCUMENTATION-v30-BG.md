<!-- Version: 1.0093 -->
# Pupikes-meme-1 (PUPIKES1) Token - Документация v30
...
Router → Pair: Swap
Pair → Router: Изпраща PUPIKES1
Router → User: Получава PUPIKES1
...
```
1. User купува 500 PUPIKES1 от PancakeSwap
2. Router → User transfer
3. User плаща 0.08% fee (получава 499.6 PUPIKES1)
4. Няма cooldown за buy
```

### Use Case 3: Normal User продава в DEX
```
1. User продава 800 PUPIKES1
2. User → Router transfer
3. Fee: 0.08% (Router получава 799.36 PUPIKES1)
4. Cooldown: 2 часа за следваща трансакция
```

### Use Case 4: Exempt добавя ликвидност
```
1. exemptAddress1 → Router: 50,000 PUPIKES1
