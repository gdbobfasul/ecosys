...
/**
 * @title MockPUPIKES1Distribution - Test Contract for Distribution
...
contract MockPUPIKES1Distribution is IERC20 {
    string public constant name = "Mock PUPIKES1 Distribution Test";
    string public constant symbol = "MPUPIKES1";
