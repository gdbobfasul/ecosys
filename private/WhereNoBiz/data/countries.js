// WhereNoBiz — списък с всички страни на земята, групирани по континент.
// Знамето-emoji се смята от кода в UI-я (regional indicator), затова тук
// пазим само: code (ISO-3166 alpha-2), name (англ.), continent.
// Континенти: Africa, Asia, Europe, North America, South America, Oceania.
