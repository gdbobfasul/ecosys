...
- **Билд (APK/AAB):** идва от `apk/kcy-toolkit-pdf-{huawei,rustore}-debug.apk` след меню 57 (не е в тази папка).
...
| **Политика за поверителност** | подава се като URL в AGC + показва се в апа (правило 7.1) | [`hw-privacy.html`](./hw-privacy.html) → `https://selflearning.bot.nu/privacy/kcy-toolkit-pdf/hw-privacy.html` |
...
| **Политика за поверителност (руски)** | подава се като URL в RuStore Console + в апа | [`rustore-privacy.html`](./rustore-privacy.html) → `https://selflearning.bot.nu/privacy/kcy-toolkit-pdf/rustore-privacy.html` |
...
_Политики онлайн: Huawei → `https://selflearning.bot.nu/privacy/kcy-toolkit-pdf/hw-privacy.html` · RuStore → `https://selflearning.bot.nu/privacy/kcy-toolkit-pdf/rustore-privacy.html` (качват се на сървъра чрез меню 08 — sync_privacy_pages)._
