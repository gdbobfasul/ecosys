...
enforceLicense('monitor-bot', 'huawei'); // лог на инсталация СЛЕД езика (huawei билд)
// Version: 1.0013
...
startPromoAds('monitor-bot'); // реклами: старт (след интрото) + среда + край (PUPIKES_END_AD)
