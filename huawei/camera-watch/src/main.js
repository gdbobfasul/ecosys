...
enforceLicense('camera-watch', 'huawei'); // лог на инсталация СЛЕД езика (huawei билд)
// Version: 1.0014
...
startPromoAds('camera-watch'); // реклами: старт (след интрото) + среда + край (PUPIKES_END_AD)
