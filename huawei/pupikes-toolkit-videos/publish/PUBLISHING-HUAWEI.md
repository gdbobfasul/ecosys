# Публикуване в Huawei AppGallery — Pupikes Toolkit Videos
...
- **Huawei пакет:** `com.pupikes.toolkitvideos.hw`
- **Билд (APK/AAB):** `apk/huawei/release/Pupikes-Toolkit-Videos-huawei-release.apk` (подписан; строи се от меню „билд/качване").
...
> Пакетът е `com.pupikes.toolkitvideos.hw`. AppGallery **не позволява** смяна на пакета на съществуващ запис — ако качиш
> в стар запис с друг пакет, отказва с „_the name of the uploaded package is different…_". Затова:
> 1. **My apps → New app** и задай **Package name = `com.pupikes.toolkitvideos.hw`** (фиксира се веднъж — точно това).
...
| **Политика за поверителност** | подава се като URL в AGC + показва се в апа (правило 7.1) | [`hw-privacy.html`](./hw-privacy.html) → `https://selflearning.bot.nu/privacy/pupikes-toolkit-videos/hw-privacy.html` |
...
| App name | `Pupikes Toolkit Videos` |
...
|---|---|---|---|
| en | English | English (UK) _(по подр.)_ + **English (US)** | Pupikes Toolkit Videos |
| bg | Български | **Bulgarian** | Pupikes Toolkit Videos |
| ru | Русский | **Russian** | Pupikes Toolkit Videos |
| uk | Українська | **Ukrainian** | Pupikes Toolkit Videos |
| de | Deutsch | **German** | Pupikes Toolkit Videos |
| fr | Français | **French (France)** | Pupikes Toolkit Videos |
| es | Español | **Spanish (Spain)** | Pupikes Toolkit Videos |
| es-MX | Español (MX) | **Spanish (Latin America)** | Pupikes Toolkit Videos |
| it | Italiano | **Italian** | Pupikes Toolkit Videos |
| pt | Português | **Portuguese (Portugal)** + **Portuguese (Brazil)** | Pupikes Toolkit Videos |
| ar | العربية | **Arabic** | Pupikes Toolkit Videos |
| hi | हिन्दी | **Hindi** | Pupikes Toolkit Videos |
| ja | 日本語 | **Japanese** | Pupikes Toolkit Videos |
| zh-Hant | 繁體中文 | **Traditional Chinese (Taiwan, China)** + **Traditional Chinese (Hong Kong, China)** | Pupikes Toolkit Videos |
...
- **Privacy policy URL:** `https://selflearning.bot.nu/privacy/pupikes-toolkit-videos/hw-privacy.html` (подава се като **адрес**, НЕ се качва HTML). Същата политика се отваря и ВЪТРЕ в апа (footer + екран за съгласие).
...
| Поле | Стойност |
|---|---|
| App package | Manage packages → качи `apk/huawei/release/Pupikes-Toolkit-Videos-huawei-release.apk` |
...
_Политика онлайн (Huawei): `https://selflearning.bot.nu/privacy/pupikes-toolkit-videos/hw-privacy.html` — качва се на сървъра при билд/деплой (задължителния етап)._
