# plane-shooter (Warbird Rush) — описание по език
...
```
Warbird Rush is a fast arcade shoot-’em-up: pilot a plane and survive 10 increasingly difficult levels. On-device, no ads, 15 languages.
```
