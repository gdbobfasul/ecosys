...
- **Huawei пакет:** `com.pupikes.toolkitpictures.hw`
...
> Пакетът е `com.pupikes.toolkitpictures.hw`. AppGallery **не позволява** смяна на пакета на съществуващ запис — ако качиш
> в стар запис с друг пакет, отказва с „_the name of the uploaded package is different…_". Затова:
> 1. **My apps → New app** и задай **Package name = `com.pupikes.toolkitpictures.hw`** (фиксира се веднъж — точно това).
...
| **Политика за поверителност** | подава се като URL в AGC + показва се в апа (правило 7.1) | [`hw-privacy.html`](./hw-privacy.html) → `https://selflearning.bot.nu/privacy/pupikes-toolkit-pictures/hw-privacy.html` |
...
| App name | `Pupikes Toolkit Pictures` |
...
|---|---|---|---|
| en | English | English (UK) _(по подр.)_ + **English (US)** | Pupikes Toolkit Pictures |
| bg | Български | **Bulgarian** | Pupikes Toolkit Pictures |
| ru | Русский | **Russian** | Pupikes Toolkit Pictures |
| uk | Українська | **Ukrainian** | Pupikes Toolkit Pictures |
| de | Deutsch | **German** | Pupikes Toolkit Pictures |
| fr | Français | **French (France)** | Pupikes Toolkit Pictures |
| es | Español | **Spanish (Spain)** | Pupikes Toolkit Pictures |
| es-MX | Español (MX) | **Spanish (Latin America)** | Pupikes Toolkit Pictures |
| it | Italiano | **Italian** | Pupikes Toolkit Pictures |
| pt | Português | **Portuguese (Portugal)** + **Portuguese (Brazil)** | Pupikes Toolkit Pictures |
| ar | العربية | **Arabic** | Pupikes Toolkit Pictures |
| hi | हिन्दी | **Hindi** | Pupikes Toolkit Pictures |
| ja | 日本語 | **Japanese** | Pupikes Toolkit Pictures |
| zh-Hant | 繁體中文 | **Traditional Chinese (Taiwan, China)** + **Traditional Chinese (Hong Kong, China)** | Pupikes Toolkit Pictures |
...
- **Privacy policy URL:** `https://selflearning.bot.nu/privacy/pupikes-toolkit-pictures/hw-privacy.html` (подава се като **адрес**, НЕ се качва HTML). Същата политика се отваря и ВЪТРЕ в апа (footer + екран за съгласие).
...
_Политика онлайн (Huawei): `https://selflearning.bot.nu/privacy/pupikes-toolkit-pictures/hw-privacy.html` — качва се на сървъра при билд/деплой (задължителния етап)._
