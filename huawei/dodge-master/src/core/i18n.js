...
const STR = {
  ...
  tagline: {
    bg: 'Движи се и избягвай снарядите!', ru: 'Двигайся и уворачивайся от снарядов!',
    uk: 'Рухайся й ухиляйся від снарядів!', en: 'Move and dodge the projectiles!',
    de: 'Beweg dich und weiche den Geschossen aus!', fr: 'Bouge et esquive les projectiles !',
    es: '¡Muévete y esquiva los proyectiles!', 'es-MX': '¡Muévete y esquiva los proyectiles!',
    it: 'Muoviti e schiva i proiettili!', pt: 'Mexa-se e desvie dos projéteis!',
    ar: 'تحرّك وتفادَ المقذوفات!', hi: 'चलो और गोलों से बचो!',
    ja: '動いて飛び道具をかわせ！', ky: 'Жыла да октордон качып кет!',
    'zh-Hant': '移動並閃避飛來的投射物！'
  },
  play_level: {
  ...
  win_title: {
    bg: 'ОЦЕЛЯ!', ru: 'ТЫ ВЫЖИЛ!', uk: 'ТИ ВИЖИВ!', en: 'YOU SURVIVED!',
    de: 'ÜBERLEBT!', fr: 'TU AS SURVÉCU !', es: '¡SOBREVIVISTE!', 'es-MX': '¡SOBREVIVISTE!',
    it: 'SEI SOPRAVVISSUTO!', pt: 'VOCÊ SOBREVIVEU!', ar: 'نجوت!', hi: 'तुम बच गए!',
    ja: '生き残った！', ky: 'АМАН КАЛДЫҢ!', 'zh-Hant': '你存活了！'
  },
  lose_title: {
    bg: 'УЦЕЛЕН СИ!', ru: 'В ТЕБЯ ПОПАЛИ!', uk: 'У ТЕБЕ ВЛУЧИЛИ!', en: 'YOU’RE HIT!',
    de: 'GETROFFEN!', fr: 'TOUCHÉ !', es: '¡TE DIERON!', 'es-MX': '¡TE DIERON!',
    it: 'COLPITO!', pt: 'VOCÊ FOI ATINGIDO!', ar: 'أُصبت!', hi: 'तुम्हें लग गई!',
    ja: '被弾！', ky: 'ТИЙИП КАЛДЫҢ!', 'zh-Hant': '你被擊中了！'
  },
  level_n: {
  ...
  score_line: {
    bg: 'Точки: {0}   •   Избегнати: {1}', ru: 'Очки: {0}   •   Уклонения: {1}',
    uk: 'Очки: {0}   •   Ухилення: {1}', en: 'Score: {0}   •   Dodged: {1}',
    de: 'Punkte: {0}   •   Ausgewichen: {1}', fr: 'Score : {0}   •   Esquives : {1}',
    es: 'Puntos: {0}   •   Esquivados: {1}', 'es-MX': 'Puntos: {0}   •   Esquivados: {1}',
    it: 'Punti: {0}   •   Schivate: {1}', pt: 'Pontos: {0}   •   Desviados: {1}',
    ar: 'النقاط: {0}   •   تفادٍ: {1}', hi: 'स्कोर: {0}   •   बचाव: {1}',
    ja: 'スコア: {0}   •   回避: {1}', ky: 'Упай: {0}   •   Качуу: {1}',
    'zh-Hant': '分數：{0}   •   閃避：{1}'
  },
  enter_name: {
