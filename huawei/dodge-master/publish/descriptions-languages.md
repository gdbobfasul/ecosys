# dodge-master (EvadeArena) — описание по език
...
```
EvadeArena is a top-down survival arcade game: you dodge projectiles across 10 levels of rising difficulty and climb a local leaderboard. On-device, no ads, 15 languages.
```
