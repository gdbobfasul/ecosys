# Публикуване в Huawei AppGallery — Pupikes Toolkit AI Announcement
...
- **Huawei пакет:** `com.pupikes.toolkitai.hw`
- **Билд (APK/AAB):** `apk/huawei/release/Pupikes-Toolkit-AI-Announcement-huawei-release.apk` (подписан; строи се от меню „билд/качване").
...
> Пакетът е `com.pupikes.toolkitai.hw`. AppGallery **не позволява** смяна на пакета на съществуващ запис — ако качиш
> в стар запис с друг пакет, отказва с „_the name of the uploaded package is different…_". Затова:
> 1. **My apps → New app** и задай **Package name = `com.pupikes.toolkitai.hw`** (фиксира се веднъж — точно това).
...
| **Политика за поверителност** | подава се като URL в AGC + показва се в апа (правило 7.1) | [`hw-privacy.html`](./hw-privacy.html) → `https://selflearning.bot.nu/privacy/pupikes-toolkit-ai-announcement/hw-privacy.html` |
...
| App name | `Pupikes Toolkit AI Announcement` |
...
|---|---|---|---|
| en | English | English (UK) _(по подр.)_ + **English (US)** | Pupikes Toolkit AI Announcement |
| bg | Български | **Bulgarian** | Pupikes Toolkit AI Announcement |
| ru | Русский | **Russian** | Pupikes Toolkit AI Announcement |
| uk | Українська | **Ukrainian** | Pupikes Toolkit AI Announcement |
| de | Deutsch | **German** | Pupikes Toolkit AI Announcement |
| fr | Français | **French (France)** | Pupikes Toolkit AI Announcement |
| es | Español | **Spanish (Spain)** | Pupikes Toolkit AI Announcement |
| es-MX | Español (MX) | **Spanish (Latin America)** | Pupikes Toolkit AI Announcement |
| it | Italiano | **Italian** | Pupikes Toolkit AI Announcement |
| pt | Português | **Portuguese (Portugal)** + **Portuguese (Brazil)** | Pupikes Toolkit AI Announcement |
| ar | العربية | **Arabic** | Pupikes Toolkit AI Announcement |
| hi | हिन्दी | **Hindi** | Pupikes Toolkit AI Announcement |
| ja | 日本語 | **Japanese** | Pupikes Toolkit AI Announcement |
| zh-Hant | 繁體中文 | **Traditional Chinese (Taiwan, China)** + **Traditional Chinese (Hong Kong, China)** | Pupikes Toolkit AI Announcement |
...
| 3 (под-категория) | **Efficiency** |

**Пълен път:** `Apps > Business > Efficiency`
...
- **Privacy policy URL:** `https://selflearning.bot.nu/privacy/pupikes-toolkit-ai-announcement/hw-privacy.html` (подава се като **адрес**, НЕ се качва HTML). Същата политика се отваря и ВЪТРЕ в апа (footer + екран за съгласие).
...
| Поле | Стойност |
|---|---|
| App package | Manage packages → качи `apk/huawei/release/Pupikes-Toolkit-AI-Announcement-huawei-release.apk` |
...
_Политика онлайн (Huawei): `https://selflearning.bot.nu/privacy/pupikes-toolkit-ai-announcement/hw-privacy.html` — качва се на сървъра при билд/деплой (задължителния етап)._
