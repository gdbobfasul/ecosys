...
src/
  ...
  scenes/
    ...
    gameover.js
  store/
    huawei-sdk.js       # IAP/ревю стъб (без реална интеграция)
  shims/empty.js        # шим за Node-only модули при bundle
store/                  # LISTING / CHECKLIST / TESTING бележки
```

## Защо без HMS/GMS
Чист web + Capacitor + sql.js. Няма Huawei Mobile Services / Google Play Services /
Firebase / реклами / аналитика / мрежа. Подходящо за Huawei AppGallery.
