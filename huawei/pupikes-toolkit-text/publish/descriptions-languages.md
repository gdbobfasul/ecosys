# pupikes-toolkit-text — описание по език (Brief + Full + New features)
...
```
Set of text utilities
```
**Full introduction:**
```
Pupikes Toolkit Text is a set of text utilities: word and character counters, case and formatting helpers, Base64 encoding — fully on-device.
...
```
Pupikes Toolkit Text is a set of text utilities: word and character counters, case and formatting helpers, Base64 encoding — fully on-device. On-device, no ads, 15-language interface.
```
