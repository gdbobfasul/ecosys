# pupikes-toolkit-scraper — описание по език (Brief + Full + New features)
...
```
Web page you point it to and
```
**Full introduction:**
```
Pupikes Toolkit Scraper downloads a web page you point it to and extracts the parts you asked for (text, links, tables) so you can copy or save them.
...
```
Pupikes Toolkit Scraper downloads a web page you point it to and extracts the parts you asked for (text, links, tables) so you can copy or save them. On-device, no ads, 15-language interface.
```
