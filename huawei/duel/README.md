...
- **Магазин:** Huawei AppGallery · **App ID:** `com.pupikes.duel.huawei`
...
src/theme.js            акцент на темата (сапфирено синьо — per-store)
...
- Без реклами, без плащания, без външни услуги, без HMS Kits.

## Различия от rustore копието
Само **App ID** (`.rustore`), **акцентът на темата** (`src/theme.js`) и текстовете
