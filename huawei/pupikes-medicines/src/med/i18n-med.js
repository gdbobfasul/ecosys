...
const S = {
  ...
  res_leaflet: { bg: 'Листовка', ru: 'Инструкция (листок-вкладыш)', en: 'Leaflet' },
  res_indications: { bg: 'Показания (за какво е)', ru: 'Показания', en: 'Indications' },
  res_dosage: { bg: 'Дозировка и прием', ru: 'Дозировка и приём', en: 'Dosage & administration' },
  res_contraindications: { bg: 'Противопоказания', ru: 'Противопоказания', en: 'Contraindications' },
  res_sideeffects: { bg: 'Странични ефекти', ru: 'Побочные эффекты', en: 'Side effects' },
  res_interactions: { bg: 'Взаимодействия', ru: 'Взаимодействия', en: 'Interactions' },
  res_storage: { bg: 'Съхранение', ru: 'Хранение', en: 'Storage' },
