...
| Поле | Попълни |
|---|---|
| App package | Manage packages → качи `apk/newslator-huawei-release.apk` |
...
| Privacy policy URL | `https://selflearning.bot.nu/privacy/newslator/hw-privacy.html` |
