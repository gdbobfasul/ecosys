...
| Поле | Попълни |
|---|---|
| App package | Manage packages → качи `apk/houselookbook-huawei-release.apk` |
...
| Privacy policy URL | `https://selflearning.bot.nu/privacy/houselookbook/hw-privacy.html` |
