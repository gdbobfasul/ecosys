...
**Full introduction:**
```
Pupikes Toolkit is an all-in-one utility box: QR codes, password and text tools, calculators, image and PDF compression, currency rates and crypto charts, a web scraper and a free AI text helper. Most tools run entirely on-device; a few fetch live online data.

The offline tools (QR, passwords, calculators, text tools, image/PDF compression) run fully on-device. Your settings stay local. There is no account.
...
```
Pupikes Toolkit is an all-in-one utility box: QR codes, password and text tools, calculators, image and PDF compression, currency rates and crypto charts, a web scraper and a free AI text helper. On-device, no ads, 15-language interface.
```
