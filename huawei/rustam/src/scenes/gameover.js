...
export default class GameOverScene extends Phaser.Scene {
  ...
  init(data) {
    ...
    this.score = data.score || 0;                 // натрупани краставици (целия забег)
    this.collected = data.collected || 0;         // набрани в това ниво
  ...
  doSave() {
    ...
    this.saved = true;
    const name = (this.getNameValue() || lastName() || 'Рустам').slice(0, 24).trim() || 'Рустам';
    setLastName(name);
