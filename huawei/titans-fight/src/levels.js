...
export const LEVELS = [
  {
    ...
    weapons: ['fists'], specialChance: 0.02, heroBonusHp: 0,
  ...
  },
  {
    ...
    weapons: ['fists', 'saber'], specialChance: 0.04, heroBonusHp: 0,
  ...
  },
  {
    ...
    weapons: ['saber', 'hammer'], specialChance: 0.06, heroBonusHp: 10,
  ...
  },
  {
    ...
    weapons: ['saber', 'hammer', 'cannonball'], specialChance: 0.08, heroBonusHp: 10,
  ...
  },
  {
    ...
    weapons: ['hammer', 'cannonball'], specialChance: 0.10, heroBonusHp: 20,
  ...
  },
  {
    ...
    weapons: ['saber', 'hammer', 'cannonball', 'bomb'], specialChance: 0.12, heroBonusHp: 20,
  ...
  },
  {
    ...
    weapons: ['hammer', 'cannonball', 'bomb'], specialChance: 0.15, heroBonusHp: 30,
  ...
  },
  {
    ...
    weapons: ['saber', 'hammer', 'cannonball', 'bomb'], specialChance: 0.18, heroBonusHp: 30,
  ...
  },
  {
    ...
    weapons: ['hammer', 'cannonball', 'bomb'], specialChance: 0.22, heroBonusHp: 40,
  ...
  },
  {
    ...
    weapons: ['saber', 'hammer', 'cannonball', 'bomb'], specialChance: 0.28, heroBonusHp: 50,
