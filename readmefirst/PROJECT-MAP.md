# KCY Ecosystem — карта на проекта (за Claude Code)

Това е monorepo на **KCY екосистема** — мрежа от свързани уеб-приложения: крипто токен (BRCH1/KCY1), мултисиг портфейл, анонимен чат, портал за платени услуги и игри. Текуща версия: **1.0138** (виж файла `00039.version` — той винаги държи най-високата версия).
