...
Pupikes Chat използва **Stripe Checkout** за плащания.
...
**⚠️ Pupikes Chat не автоматично refund-ва!**

Admin трябва ръчно да:
1. Refund в Stripe
2. Mark user as unpaid в Pupikes Chat
...
**Pupikes Chat работи с всички Stripe-supported карти.**
