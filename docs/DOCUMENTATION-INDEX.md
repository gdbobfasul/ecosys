...
- **APPS-AND-ROBOTS.md** - 🤖 Пълен преглед: какво правят и какво НЕ правят всичките 34 приложения (готовност за публикуване), всички помощни роботи (BugBot тест-робот, AppPreparePublishingBot, Medikit Harvester, SelfLearning събирач, kcy-diag) с „какво още се желае", и честно обяснение на 404-проблема с правните страници
