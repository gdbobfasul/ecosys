...
# sync-assets. Пипа САМО тежките ПЕР-АП АНИМАЦИИ:
#   public/assets/animations/<Име=id>
# ВАЖНО: НИКОГА не изключва правни документи (public/privacy/<id>) или икони (apk/icons/<id>.png) —
# те трябва да се качват за ВСИЧКИ приложения независимо от обхвата (иначе документите изчезват → 404).
