...
echo "     ${CYAN}TARGET_${TARGET_NAME}_SERVER=\"${SERVER_IP}\"${NC}"
echo "     ${CYAN}TARGET_${TARGET_NAME}_PORT=\"${NEW_SSH_PORT}\"${NC}"
echo ""
echo "  3. Първи deploy от Windows:"
echo "     ${CYAN}от менюто: опция 4 (Deploy проекта) за target ${TARGET_NAME}${NC}"
echo ""
echo "     Опция 4 ще извика инсталацията (опция 2/4) автоматично в края."
echo ""
