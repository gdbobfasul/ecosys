...
// PUPIKES1 Token v33 - MEDIUM PRIORITY Tests (NEW)
// These are BRAND NEW tests not in the original test suite
// Priority 2 (MEDIUM) - Implement After High Priority
// Use with Hardhat: npx hardhat test test/pupikes-meme-1-medium-priority-tests-v33.js

const { expect } = require("chai");
const { ethers } = require("hardhat");
const { time } = require("@nomicfoundation/hardhat-network-helpers");

describe("PUPIKES1 Token v33 - MEDIUM PRIORITY TESTS (NEW)", function() {
    let token;
    let owner;
